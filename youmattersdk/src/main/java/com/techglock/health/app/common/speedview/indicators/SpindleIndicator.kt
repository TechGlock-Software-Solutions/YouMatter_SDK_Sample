package com.techglock.health.app.common.speedview.indicators
...
class SpindleIndicator(context: Context) : Indicator<SpindleIndicator>(context) {
    ...
    override fun updateIndicator() {
        ...
        indicatorPath.quadTo(
            getCenterX() - width,
            getViewSize() * .34f + speedometer!!.padding,
            getCenterX(),
            getViewSize() * .18f + speedometer!!.padding
        )
        indicatorPath.quadTo(
            getCenterX() + width,
            getViewSize() * .34f + speedometer!!.padding,
