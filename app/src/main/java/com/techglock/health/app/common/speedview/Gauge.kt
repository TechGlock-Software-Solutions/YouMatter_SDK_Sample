        ...
        when (noOfSections) {
            3 -> {
                if (reverseSections) {
                    ...
                    _sections.add(
                        Section(.66f, 1f, darkGreen.toInt(), speedometerWidth).inGauge(
                            this
                        )
                    )
                } else {
                    _sections.add(
                        Section(0f, .33f, darkGreen.toInt(), speedometerWidth).inGauge(
                            this
                        )
                    )
                    _sections.add(
            ...
            4 -> {
                if (reverseSections) {
                    ...
                    _sections.add(
                        Section(.50f, .75f, lightGreen.toInt(), speedometerWidth).inGauge(
                            this
                        )
                    )
                    _sections.add(
                        Section(.75f, 1f, darkGreen.toInt(), speedometerWidth).inGauge(
                            this
                        )
                    )
                } else {
                    _sections.add(
                        Section(0f, .25f, darkGreen.toInt(), speedometerWidth).inGauge(
                            this
                        )
                    )
                    _sections.add(
                        Section(.25f, .50f, lightGreen.toInt(), speedometerWidth).inGauge(
                            this
                        )
                    )
                    _sections.add(
                ...
                if (reverseSections) {
                    ...
                    _sections.add(Section(.4f, .6f, yellow.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(
                        Section(.6f, .8f, lightGreen.toInt(), speedometerWidth).inGauge(
                            this
                        )
                    )
                    _sections.add(
                    ...
                    _sections.add(
                        Section(.2f, .4f, lightGreen.toInt(), speedometerWidth).inGauge(
                            this
                        )
                    )
                    _sections.add(Section(.4f, .6f, yellow.toInt(), speedometerWidth).inGauge(this))
