...
class ModalBottomSheetOTPSignup(
    private val mobile: String, private var listener: OnVerifyClickListener,
    private val signUpStep1Fragment: SignUpStep1Fragment
    ...
    private fun setClickable() {
        ...
        binding.txtResend.setOnClickListener {
            signUpStep1Fragment.viewModel.callGenerateVerificationCode(
                "",
                mobile,
                signUpStep1Fragment
            )
